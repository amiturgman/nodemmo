...
Currently, the client side is a simulation of how the world is look like from the 30 miles above.
...
This will trigger a random location-update event beeing sent to the server, and propagate to all users connected to one of the servers.
...
![http location](https://github.com/amiturgman/nodemmo/raw/master/img/http-location.png "triggers http location change event")
